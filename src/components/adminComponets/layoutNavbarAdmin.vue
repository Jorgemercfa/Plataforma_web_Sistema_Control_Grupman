...
const menu = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Compras',      icon: '🛒', ruta: '/Business-purchases' },
...
const cerrarSesion = () => {
  ...
  // 2. Redirigir a la vista de Login (Asegúrate de tener la ruta '/login' o cámbiala por la tuya)
  router.push('/');
};
</script>
    ...
    <div class="main-wrapper">
      ...
      <header class="topbar">
        ...
        <div class="topbar-right">
          ...
          <!-- Avatar + menú usuario (ref agregada para detectar clics fuera) -->
          <div class="topbar-user" ref="userMenuRef" @click="toggleMenuUsuario">
            ...
            <!-- Dropdown desplegable convertidos a botones semánticos -->
